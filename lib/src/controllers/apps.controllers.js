...
exports.listWorkspaceApps = exports.createNewApp = void 0;
...
const listWorkspaceApps = (user, workspace_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        progress_asset_1.default.stop();
        apps.map((app) => {
            console.log(`->  ${(0, chalk_1.green)(`APP_ID: `)}${app._id} ${(0, chalk_1.green)('APP_NAME: ')}${app.app_name} ${(0, chalk_1.green)('ACTIVE: ')}${app.active} ${(0, chalk_1.green)('ENVS: ')}${app.envs.length}`);
        });
    }
    catch (e) {
        progress_asset_1.default.stop();
