...
const actions_controllers_1 = require("./controllers/actions.controllers");
...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (input.includes('access')) {
        ...
        yield (0, signup_controllers_1.default)();
    }
        ...
        if (flags.new) { }
        yield (0, actions_controllers_1.createNewAction)(user);
    }
}))();
