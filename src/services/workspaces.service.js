...
import { WORKSPACE_CREATE_URL, WORKSPACE_FETCH_URL, WORKSPACE_DEFAULT_CHANGE, WORKSPACE_UPDATE_ENVS, WORKSPACE_ACCESS_CREATE } from "../config/urls";
...
export const createAccess = async(payload) => {
    try {
        ...
        return workspaceClient(`Bearer ${token}`, "application/json").post(WORKSPACE_ACCESS_CREATE, {user_id, workspace_id, public_key, email, access_level});
